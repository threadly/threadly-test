...
public class TestRunnable implements Runnable {
  ...
  private final ConcurrentLinkedQueue<Long> runTime;
  ...
  public TestRunnable(int runTimeInMillis) {
    ...
    this.runTime = new ConcurrentLinkedQueue<>();
  ...
  public long getDelayTillRun(int runNumber, int timeout) {
    ...
    List<Long> runTime = new ArrayList<>(this.runTime);
  ...
  public final void run() {
    ...
    runTime.add(Clock.accurateForwardProgressingMillis());
    try {
      handleRunStart();
